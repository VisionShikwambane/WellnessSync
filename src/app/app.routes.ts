...
export const routes: Routes = [
  ...
  {
    path: 'bookings',
    loadComponent: () => import('./patient/bookings/bookings.page').then( m => m.BookingsPage)
  },
  {
    path: 'partient-home',
    loadComponent: () => import('./patient/parient-home/parient-home.page').then( m => m.ParientHomePage)
  },
